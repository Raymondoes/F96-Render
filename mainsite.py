...
st.write("- GoldLuigi7 the creator of February 96")
...
with st.container():
    ...
    with left_column:
        ...
        st.write("##")
        st.write("""to simplify on what February 96 was about, February 96 is a ROM Hack created by GoldLuigi7 and it is supposed to be a cartoony/beta version of SM64, the first Rom Hack was worked on in October 28.
